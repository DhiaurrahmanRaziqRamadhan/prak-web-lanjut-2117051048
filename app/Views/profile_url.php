...
<head>
    ...
    <style>
        body {
            background: linear-gradient(90deg, rgba(16,0,249,1) 0%, rgba(0,224,255,1) 100%);
...
<body>
    <div class="d-flex align-items-center justify-content-center" style="height: 100vh;">
        <div class="p-2 border shadow rounded bg-light">
            <div>
                <img class="border border-primary border-3 mx-auto d-block rounded-circle shadow" src="<?= base_url('foto.jpg') ?>" width="200px">
            </div>
